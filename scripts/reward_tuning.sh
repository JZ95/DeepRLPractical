...
python $CODE_PATH/main.py \
    --log-dir $LOG_DIR/'closer2ball-0.25-closer2-goal-0.25-goal-dist-lim-0.75' \
    --t-max 1000000 \
    --n-jobs 8 \
    --eps-decay 30000 \
...
python $CODE_PATH/main.py \
    --log-dir $LOG_DIR/'closer2ball-0.25-closer2-goal-0.25-goal-dist-lim-0.5' \
    --t-max 1000000 \
    --n-jobs 8 \
    --eps-decay 30000 \
    --reward-opt 'closer2ball-0.25-closer2-goal-0.25-goal-dist-lim-0.5'