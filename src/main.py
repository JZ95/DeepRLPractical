...
def get_args():
    ...
    parser.add_argument('--i-async_update', type=int, default=200)
    parser.add_argument('--i-target', type=int, default=5000)
    parser.add_argument('--discountFactor', type=float, default=0.99)

    parser.add_argument('--eps-end', type=float, default=0.10)
    parser.add_argument('--eps-start', type=float, default=0.98)
    parser.add_argument('--eps-decay', type=float, default=500000.0)
